...
return [
    ...
    'export' => 'تصدير CSV',
    'import' => 'استيراد CSV',
    'import_leads' => 'استيراد عملاء محتملين',
    'upload_csv_file' => 'ارفع ملف CSV',
    'upload_csv_hint' => 'أول صف في الملف لازم يكون فيه أسماء الأعمدة.',
    'choose_file' => 'ملف CSV',
    'upload_and_continue' => 'رفع ومتابعة',
    'map_columns' => 'مطابقة الأعمدة',
    'map_columns_subtitle' => 'اربط كل عمود من ملفك بحقل عميل، أو تجاهله.',
    'csv_column' => 'عمود CSV',
    'maps_to' => 'يتطابق مع',
    'ignore_field' => '— تجاهل —',
    'confirm_import' => 'تأكيد الاستيراد',
    'back' => 'رجوع',
    'import_queued' => 'الاستيراد بدأ وهيخلص خلال لحظات.',
    'import_status' => 'حالة الاستيراد',
    'total_rows' => 'إجمالي الصفوف',
    'imported_rows' => 'اتستورد',
    'skipped_rows' => 'اتجاهل (مكرر)',
    'failed_rows' => 'فشل',
    'status_processing' => 'جاري المعالجة',
    'status_completed' => 'اكتمل',
    'status_completed_with_errors' => 'اكتمل مع بعض الأخطاء',
    'status_failed' => 'فشل',
    'error_log' => 'أخطاء الصفوف',
    'row' => 'الصف',
    'reason' => 'السبب',
